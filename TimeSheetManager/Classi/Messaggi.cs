...
namespace TimeSheetManager.Classi
{
    public class MessaggiAlert
    {
        ...
        public const string GIORNATE_TOTALI_NON_CONFORME_A_SINGOLE_FIGURE = "Il totale delle giornate inserito non è conforme al numero di giornate per figura professionale";
